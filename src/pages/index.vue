...
<template>
  <div class="">
    <div class="flex md:!flex-row flex-col items-center justify-center mb-6 mt-14 gap-2">
      ...
      <h1 class="text-primary dark:invert text-3xl md:!text-6xl font-bold" style="color: brown;">
        {{ $t('pages.title') }}
      </h1>
      <div class="badge badge-primary badge-outline dark:invert mt-1 text-sm md:!mt-8" style="color: brown;">
        {{ $t('pages.tag') }}
      </div>
    </div>
